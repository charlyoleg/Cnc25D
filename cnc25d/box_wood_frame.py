...
def box_wood_frame(ai_box_width, ai_box_depth, ai_box_height,
  ...
  def hole_in_plank_top_xz_for_yz(nai_x_offset, nai_cutting_extra):
    l_outline = [
      ...
      [nai_x_offset-1.0/2*ai_plank_height-1*nai_cutting_extra, ai_crenel_depth+1.0/3*(ai_h_plank_width-ai_crenel_depth)-1*nai_cutting_extra,-1*ai_reamer_radius]]
    l_hole_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(l_outline).Edges))
  ...
  def jonction_plank_z_with_wall_diagonal(nai_cutting_extra):
    nr = cnc_cut_outline.outline_shift_xy(jonction_plank_xz_with_wall_diagonal(nai_cutting_extra), -1*ai_v_plank_width+1*ai_crenel_depth, 1, ai_v_plank_width, -1)
    return(nr)
  ...
  def jonction_plank_zx_with_wall_diagonal(nai_cutting_extra):
    nr = cnc_cut_outline.outline_shift_xy(jonction_plank_xz_with_wall_diagonal(nai_cutting_extra), -1*ai_v_plank_width+1*ai_crenel_depth, 1, 0*ai_v_plank_width, 1)
    return(nr)
  ...
  def plank_xz_yz_hole(nai_box_nb, nai_cutting_extra, nai_box_size):
    ...
    plank_xz_hole_shape = cnc_cut_outline.cnc_cut_outline(plank_xz_hole_outline)
  ...
  def plank_xz_top(nai_module_width, nai_cutting_extra):
    ...
    for i in range(nai_module_width-1):
      ...
      plank_xz_top_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_xz_with_middle_zx(nai_cutting_extra),      (i+1)*ai_box_width,  1))
      plank_xz_top_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_xz_with_wall_diagonal(nai_cutting_extra),  (i+1)*ai_box_width-1.0/2*ai_v_plank_width, 1))
    ...
    # extrusion
    plank_xz_top_shape = cnc_cut_outline.cnc_cut_outline(plank_xz_top_outline)
  ...
  def plank_xz_bottom(nai_module_width, nai_cutting_extra):
    ...
    for i in range(nai_module_width-1):
      ...
      plank_xz_bottom_outline.extend(cnc_cut_outline.outline_shift_xy(jonction_plank_xz_with_middle_zx(nai_cutting_extra),      (nai_module_width-i-1)*ai_box_width, 1, 1*(ai_h_plank_width+ai_fitting_height), -1))
      plank_xz_bottom_outline.extend(cnc_cut_outline.outline_shift_xy(jonction_plank_xz_with_wall_diagonal(nai_cutting_extra),  (nai_module_width-i-1)*ai_box_width+1.0/2*ai_v_plank_width, -1, 1*(ai_h_plank_width+ai_fitting_height), -1))
    ...
    # extrusion
    #plank_xz_bottom_shape = cnc_cut_outline.cnc_cut_outline(plank_xz_bottom_outline)
    ...
    plank_xz_bottom_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(plank_xz_bottom_outline).Edges))
  ...
  def plank_yz_top(nai_cutting_extra):
    ...
    # extrusion
    plank_yz_top_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(plank_yz_top_outline).Edges))
  ...
  def plank_yz_bottom(nai_cutting_extra):
    ...
    # extrusion
    plank_yz_bottom_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(plank_yz_bottom_outline).Edges))
  ...
  def plank_z_side(nai_cutting_extra):
    ...
    plank_z_side_outline = []
    plank_z_side_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_z_side_with_xz(nai_cutting_extra), 0*plank_z_side_length, 1))
    plank_z_side_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_z_side_with_xz(nai_cutting_extra), 1*plank_z_side_length,-1))
    plank_z_side_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_z_with_wall_diagonal(nai_cutting_extra), 1*plank_z_side_length,-1))
    plank_z_side_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_z_with_wall_diagonal(nai_cutting_extra), 0*plank_z_side_length, 1))
    # extrusion
    plank_z_side_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(plank_z_side_outline).Edges))
  ...
  def plank_wall_diagonal(nai_cutting_extra):
    ...
    plank_wall_diagonal_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_wall_diagonal(nai_cutting_extra), 1*plank_wall_diagonal_length, -1))
    plank_wall_diagonal_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_wall_diagonal(nai_cutting_extra), 0*plank_wall_diagonal_length,  1))
    plank_wall_diagonal_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(plank_wall_diagonal_outline).Edges))
  ...
  def plank_tobo_diagonal(nai_cutting_extra):
    ...
    plank_tobo_diagonal_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(plank_tobo_diagonal_outline).Edges))
  ...
  def plank_zx_middle(nai_cutting_extra):
    ...
    plank_zx_middle_outline.extend(cnc_cut_outline.outline_shift_xy(jonction_plank_zx_with_wall_diagonal(nai_cutting_extra), 0*plank_z_side_length, 1, 0*ai_v_plank_width, 1))
    plank_zx_middle_outline.extend(cnc_cut_outline.outline_shift_xy(jonction_plank_zx_with_wall_diagonal(nai_cutting_extra), 1*plank_z_side_length,-1, 0*ai_v_plank_width, 1))
    plank_zx_middle_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_zx_with_xz(nai_cutting_extra), 1*plank_z_side_length,-1))
    plank_zx_middle_outline.extend(cnc_cut_outline.outline_shift_xy(jonction_plank_zx_with_wall_diagonal(nai_cutting_extra), 1*plank_z_side_length,-1, 1*ai_v_plank_width, -1))
    plank_zx_middle_outline.extend(cnc_cut_outline.outline_shift_xy(jonction_plank_zx_with_wall_diagonal(nai_cutting_extra), 0*plank_z_side_length, 1, 1*ai_v_plank_width, -1))
    plank_zx_middle_outline.extend(cnc_cut_outline.outline_shift_x(jonction_plank_zx_with_xz(nai_cutting_extra), 0*plank_z_side_length, 1))
    plank_zx_middle_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(plank_zx_middle_outline).Edges))
  ...
  def plank_hole_cover(nai_cutting_extra):
    ...
    plank_hole_cover_face = Part.Face(Part.Wire(cnc_cut_outline.cnc_cut_outline(plank_hole_cover_outline).Edges))
...
"""
  ...
  def fg_dxf(ai_solid, ai_file_idx, ai_text_report, ai_output_dir, ai_output_basename, ai_file_basename2, ai_file_description):
    ...
    l_file_path = fg_file_path(ai_output_dir, l_file_name) 
    export_2d.export_to_dxf(ai_solid, Base.Vector(0,0,1), 1.0, l_file_path) # slice the plank in the XY plan at a height of 1.0
    l_text_report = ai_text_report + fg_text_report(l_file_idx, l_file_name, l_file_description, os.path.getsize(l_file_path))
    r_fg = (l_file_idx, l_text_report)
    return(r_fg)
  ...
  def fg_svg(ai_solid, ai_file_idx, ai_text_report, ai_output_dir, ai_output_basename, ai_file_basename2, ai_file_description):
    ...
    l_file_path = fg_file_path(ai_output_dir, l_file_name) 
    export_2d.export_to_svg(ai_solid, Base.Vector(0,0,1), 1.0, l_file_path) # slice the plank in the XY plan at a height of 1.0
    l_text_report = ai_text_report + fg_text_report(l_file_idx, l_file_name, l_file_description, os.path.getsize(l_file_path))
    r_fg = (l_file_idx, l_text_report)
    return(r_fg)
  ...
  def fg_xyz_dxf(ai_solid, ai_file_idx, ai_text_report, ai_output_dir, ai_output_basename, ai_file_basename2, ai_file_description):
    ...
    export_2d.export_xyz_to_dxf(ai_solid, ai_module_width*ai_box_width, ai_box_depth, ai_box_height, l_xy_slice_list, l_xz_slice_list, l_yz_slice_list, l_file_path)
    l_text_report = ai_text_report + fg_text_report(l_file_idx, l_file_name, l_file_description, os.path.getsize(l_file_path))
    r_fg = (l_file_idx, l_text_report)
    return(r_fg)
