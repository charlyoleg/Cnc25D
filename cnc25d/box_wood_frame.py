...
def box_wood_frame(ai_box_width, ai_box_depth, ai_box_height,
  ...
  def hole_in_plank_top_xz_for_yz(nai_x_offset, nai_cutting_extra):
    l_outline = [
      ...
      [nai_x_offset-1.0/2*ai_plank_height-1*nai_cutting_extra, ai_crenel_depth+1.0/3*(ai_h_plank_width-ai_crenel_depth)-1*nai_cutting_extra,-1*ai_router_bit_radius]]
    l_hole_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(l_outline, 'hole_in_plank_top_xz_for_yz').Edges))
  ...
  def hole_in_plank_bot_xz_for_yz(nai_x_offset, nai_cutting_extra):
    l_outline = [
      ...
      [nai_x_offset-1.0/2*ai_plank_height-1*nai_cutting_extra, 1.0/3*(ai_h_plank_width+ai_fitting_height-ai_crenel_depth)-1*nai_cutting_extra,-1*ai_router_bit_radius]]
    l_hole_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(l_outline, 'hole_in_plank_bot_xz_for_yz').Edges))
    r_hole_solid = l_hole_face.extrude(Base.Vector(0,0,ai_plank_height+2*remove_skin_thickness)) # straight linear extrusion
    return(r_hole_solid)
  ...
  def plank_xz_yz_hole(nai_box_nb, nai_cutting_extra, nai_box_size):
    ...
    plank_xz_hole_shape = cnc25d_api.cnc_cut_outline(plank_xz_hole_outline, 'plank_xz_yz_hole')
  ...
  def plank_xz_top(nai_module_width, nai_cutting_extra):
    ...
    # extrusion
    plank_xz_top_shape = cnc25d_api.cnc_cut_outline(plank_xz_top_outline, 'plank_xz_top')
  ...
  def plank_xz_bottom(nai_module_width, nai_cutting_extra):
    ...
    # extrusion
    #plank_xz_bottom_shape = cnc25d_api.cnc_cut_outline(plank_xz_bottom_outline, 'plank_xz_bottom')
    ...
    plank_xz_bottom_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(plank_xz_bottom_outline, 'plank_xz_bottom').Edges))
  ...
  def plank_yz_top(nai_cutting_extra):
    ...
    # extrusion
    plank_yz_top_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(plank_yz_top_outline, 'plank_yz_top').Edges))
  ...
  def plank_yz_bottom(nai_cutting_extra):
    ...
    # extrusion
    plank_yz_bottom_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(plank_yz_bottom_outline, 'plank_yz_bottom').Edges))
  ...
  def plank_z_side(nai_cutting_extra):
    ...
    # extrusion
    plank_z_side_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(plank_z_side_outline, 'plank_z_side').Edges))
  ...
  def plank_wall_diagonal(nai_cutting_extra):
    ...
    plank_wall_diagonal_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(plank_wall_diagonal_outline, 'plank_wall_diagonal').Edges))
  ...
  def plank_tobo_diagonal(nai_cutting_extra):
    ...
    plank_tobo_diagonal_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(plank_tobo_diagonal_outline, 'plank_tobo_diagonal').Edges))
  ...
  def plank_zx_middle(nai_cutting_extra):
    ...
    plank_zx_middle_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(plank_zx_middle_outline, 'plank_zx_middle').Edges))
  ...
  def plank_hole_cover(nai_cutting_extra):
    ...
    plank_hole_cover_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(plank_hole_cover_outline, 'plank_hole_cover').Edges))
  ...
  def slab_top_bottom(nai_type, nai_cutting_extra):
    ...
    slab_top_bottom_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(slab_top_bottom_outline, 'slab_top_bottom').Edges))
  ...
  def slab_side(nai_type, nai_cutting_extra):
    ...
    slab_side_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(slab_side_outline, 'slab_side').Edges))
  ...
  def slab_front(nai_cutting_extra):
    ...
    slab_front_face = Part.Face(Part.Wire(cnc25d_api.cnc_cut_outline(slab_front_outline, 'slab_front').Edges))
