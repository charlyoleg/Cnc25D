...
def epicyclic_gearing_dictionary_init():
  ...
  ### structure
  r_egwd['sun_gear_tooth_nb']       = 19
  r_egwd['planet_gear_tooth_nb']    = 31
  r_egwd['planet_nb']               = 3
  ### gear
  r_egwd['gear_module']             = 1.0
  ...
  ### general
  r_egwd['cnc_router_bit_radius']   = 1.0
  r_egwd['gear_profile_height']     = 10.0
  ### output
  r_egwd['tkinter_view']                    = False
  r_egwd['simulation_sun_planet_gear']      = False
  r_egwd['simulation_planet_annulus_gear']  = False
  r_egwd['output_file_basename']            = ''
  ### optional
  r_egwd['args_in_txt'] = ""
  r_egwd['return_type'] = 'int_status' # possible values: 'int_status', 'cnc25d_figure', 'freecad_object'
  #### return
  return(r_egwd)
