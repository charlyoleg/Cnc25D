...
def gear_profile_self_test():
  ...
  test_case_switch = [
    ...
    ["internal-external with angle and aal" , "--gear_tooth_nb 29 --gear_type 1 --second_gear_tooth_nb 18 --gear_module 10.0 --second_gear_position_angle 1.8 --second_gear_additional_axis_length 1.3"],
