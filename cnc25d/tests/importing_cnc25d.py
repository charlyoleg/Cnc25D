...
try:
  ...
  print("dbg059: It seems you run the script from its git repository: Complete sys.path")
  sys.path.append(test_script_dir+'/../..')
  #sys.path.append('./../..') # this work only if you launch the script from its own directory
  try:
    from cnc25d import cnc25d_api
  except:
    print("ERR048: cnc25d can not be imported! Have you installed the Python package Cnc25D? or do you run the script from its git repository?")
    sys.exit(2)
